...
WebUI.scrollToElement(findTestObject('News/Page_Berita Terkini Hari Ini, Kabar Akurat _d061e2/select 2nd news'), 0)

WebUI.click(findTestObject('News/Page_Berita Terkini Hari Ini, Kabar Akurat _d061e2/select 2nd news'))
