...
WebUI.setText(findTestObject('Object Repository/News/Page_Berita Terkini Hari Ini, Kabar Akurat _d061e2/input_Otomatis_q'), 
    'ber')

WebUI.sendKeys(findTestObject('Object Repository/News/Page_Berita Terkini Hari Ini, Kabar Akurat _d061e2/input_Otomatis_q'), 
    Keys.chord(Keys.ENTER))

WebUI.scrollToElement(findTestObject('News/Page_Berita Terkini Hari Ini, Kabar Akurat _d061e2/select 2nd news after search'), 
    0)

'klik pada berita ke dua'
WebUI.click(findTestObject('News/Page_Berita Terkini Hari Ini, Kabar Akurat _d061e2/berita kedua'))
